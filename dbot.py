                ...
                if data is not None:
                    ...
                    msg.append(
                        "{name} is Explorer Rank {e:,d} and XP Rank {x:,d}.".format(
                            name=name.title(),
                            e=int(data.pop("explorer_rank", data.pop("explore rank", "").replace("th", "").replace("st", "").replace("nd", ""))),
                            x=int(data.pop("xp_rank", data.pop("xp rank", "").replace("th", "").replace("st", "").replace("nd", ""))),
                        )
                    )
